...
class _MenuSettingsPageState extends State<MenuSettingsPage> {
  ...
  void initState() {
    ...
    userProfileImage =
        "assets/images/default-profile.png"; // Path to profile image
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor:
          Color(0xFF335AAC), // Light gray background sesuai dengan gambar
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Image.asset(
                            'assets/logo/salvus-logo.png', // Path ke file logo PNG
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(
                            height: 50), // Extra space for bottom indicator
                      ],
                    ),
                  ),
                ),
  ...
  Widget _buildSettingsItemWithImage({
    ...
    double textLeftPadding =
        2.0, // Reduced default padding to bring text closer to icon
  }) {
    return InkWell(
      onTap: onTap,
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF2D5BBA),
          primary: const Color(0xFF2D5BBA),
        ),
      ),
      home: const MenuSettingsPage(),
    );
  }
}
